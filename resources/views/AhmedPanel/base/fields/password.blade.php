 <div class="@if(isset($Field['confirmation']) && $Field['confirmation']) col-md-6 @else col-md-12 @endif">
    <div class="form-group label-floating">
        <label for="{{$Field['name']}}" class="control-label">{{__('dashboard.passwords.password')}} @if($Field['is_required'])*@endif</label>
 ...
 @if(isset($Field['confirmation']) && $Field['confirmation'])
     <div class="col-md-6">
         <div class="form-group label-floating">
             <label for="password_confirmation" class="control-label">{{__(__('dashboard.passwords.password_confirmation'))}} @if($Field['is_required'])*@endif</label>
